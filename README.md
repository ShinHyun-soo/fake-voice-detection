...
| 주차  | 내용                              |
|-------|-----------------------------------|
| 0 ~ 1.5 주차 | 모델 학습 및 추론 파이프라인을 구축하였음.|
| 1.5 ~ 2 주차 | 문제를 이해하지 못해 두 라벨을 종속 사건처럼 값이 나오게 하였음. |
| 2 ~ 2.5 | 독립 사건임을 이해하여 그에 맞게 값이 나오게 하였음.|
| 2.5 ~ 3 | 어쩌다 보니 실험 결과가 좋았는데, 왜 좋게 나왔는지 해석하기 어려워서 애를 먹음. 이 기간에서 모델 학습 및 추론 시간을 각종 트릭으로 극단적으로 줄이는데 성공함.|
